...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		$data['entry_model'] = $this->language->get('entry_model');
		$data['entry_additional_name'] = $this->language->get('entry_additional_name');
		...
		if (isset($this->error['additional_name'])) {
			$data['error_additional_name'] = $this->error['additional_name'];
		} else {
			$data['error_additional_name'] = '';
		}
		...
		if (isset($this->request->post['additional_name'])) {
			$data['additional_name'] = $this->request->post['additional_name'];
		} elseif (!empty($product_info)) {
			$data['additional_name'] = $product_info['additional_name'];
		} else {
	...
	protected function validateForm() {
		...
		if (utf8_strlen($this->request->post['additional_name']) > 255) {
			$this->error['additional_name'] = $this->language->get('error_additional_name');
		}
