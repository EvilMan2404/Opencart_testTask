        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-additional_name"><?php echo $entry_additional_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="additional_name" value="<?php echo $additional_name; ?>" placeholder="<?php echo $entry_additional_name; ?>" id="input-additional_name" class="form-control" />
                  <?php if ($error_additional_name) { ?>
                  <div class="text-danger"><?php echo $error_additional_name; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
